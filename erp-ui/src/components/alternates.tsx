...
class Alternates extends Component<Props, State> {
    render() {
...
function mapStateToProps(state: IReduxState, playersProps: IPlayersProps): IPlayersState {
    return { players: state.alternates }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles, { withTheme: true })(Alternates));